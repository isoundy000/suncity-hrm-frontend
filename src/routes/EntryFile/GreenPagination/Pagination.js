...
class Pagination extends React.Component {
  ...
  render() {
    const prevPage =  this.formatMessage(getMessage('app.global.pagination.prev'));
    const nextPage =  this.formatMessage(getMessage('app.global.pagination.next'));
    ...
    if (props.simple) {
      return (
        <ul className={`${prefixCls} ${prefixCls}-simple ${props.className} ${classes['rc-pagination']}`}>
    ...
    return (
      <ul className={`${prefixCls} ${props.className} ${classes['rc-pagination']}`}
