...
import AgreeInterviewModal from '../../../Modals/AgreeInterviewModal';
import RefuseInterviewModal from '../../../Modals/RefuseInterviewModal';
...
function InterviewNeeded({ content, cardData, interviewHistory, nth, ...props }) {
  ...
  const interviewers = currentInterview.interviewer_users.map(user => user.chinese_name).join(', ');
