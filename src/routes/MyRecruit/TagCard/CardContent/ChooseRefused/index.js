...
function ChooseRefused({ content, cardData, interviewHistory, ...props }) {
  const { formatMessage } = props.intl;

  const refuseRemarkText = formatMessage(messages['app.my_recruit.card_content.choose_refuse_remark']);
