module.exports = () => {
  return {
    ...
    // Color
    '@primary-color': '#8bca5a',
    '@success-color': '#8bca5a',
    '@error-color': '#ff8965',
    '@highlight-color': '#f9c642',
    '@warning-color': '#ff8965',
    // '@normal-color': '#d9d9d9',
    ...
    '@btn-padding-base': '6px 25px',
    // '@btn-font-size-lg': '@font-size-lg',
    '@btn-padding-lg': '@btn-padding-base',
    // '@btn-padding-sm': '2px 9px',
    ...
    // Form
    // ---
    '@label-required-color': '@warning-color',
